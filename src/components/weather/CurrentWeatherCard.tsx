...
import { formatError, weatherEmoji } from '../../utils/weatherHelpers'
...
export default function CurrentWeatherCard({
  ...
  const stats = [
...

    {
      icon: FiSun,
      label: 'UV Index',
      value: hourly?.uv_index != null
        ? String(hourly.uv_index)
        : '—',
    },
  ]
